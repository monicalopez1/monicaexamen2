...
public class ControllerPeliculas {
    ...
    public ControllerPeliculas(ModelPeliculas model_pePeliculas, ViewPeliculas view_Peliculas) {
    ...
    public void getValores() {
        ...
        view_peliculas.jtf_id_peliculas.setText(" " + model_peliculas.getId_pelicula());
    ...
    public void setValores() {
        model_peliculas.setId_pelicula(Integer.parseInt(view_peliculas.jtf_id_peliculas.getText()));
        ...
        view_peliculas.jtf_descripcion.setText(view_peliculas.jtf_descripcion.getText());
